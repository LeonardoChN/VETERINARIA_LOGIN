...
urlpatterns = [
    ...
    path('addfun/',views.agregarfun),
    path('addcitas/',views.agregarcitas),
    path('addcliente/',views.agregarcliente),
    ...
    path('editarfuncionarios/<int:id>', views.actualizarfuncionario),
    path('editarclientes/<int:id>', views.actualzarcliente),
